...
> *Supported by*: three featured projects, schema migrations, query code, Docker configuration, and a résumé entry.

*Note: Confidence describes the quantity and quality of supporting evidence. It is not a universal score of talent or employability.*
...
*Rule: Avoid unsupported statements such as "Top 1% engineer", "excellent developer", or a single universal skill score.*
...
*Privacy Rule: The user must choose repositories for analysis and control which ones are visible publicly. Private repository content must never be exposed by default.*
...
### Lowering Evidence Gaps (Strengths & Gaps)
...
*Rule: Never label a developer as stagnant, declining, weak, or unhireable based on inactivity or incomplete source data.*
...
*Note: The default is user review before a public change. Users may opt into automatic publication only for low-risk update categories.*
